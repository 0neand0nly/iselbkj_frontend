...
import BoardService from '../service/ChunkService';
import cweService from '../service/CweService';
import './ReadBoardComponent.css'
const ReadChunkComponent = () => {
    const { cwe_id } = useParams();
    const navigate = useNavigate();
    const [chunk, setBoard] = useState({});
                        ...
                        <div className="col-md-6">
                            <div className="row">
                                <div className="col-md-12">
                                    <label>CWE_ID</label> : {chunk.cwe_id}
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="row">
                                <div className="col-md-12">
                                    <label>CWE_NAME</label> : {chunk.cwe_name}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-md-6">
                            <div className="row">
                                <div className="col-md-12">
                                    ...
                                    <textarea value={chunk.source_code} readOnly className="tall-textarea" />
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="row">
                                <div className="col-md-12">
                                    <label>Byte Code</label> : <br/>
                                    <textarea value={chunk.byte_code} readOnly className="tall-textarea" />
                                </div>
                            </div>
                        </div>
                    </div>
...
export default ReadChunkComponent;
